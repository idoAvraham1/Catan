...
int main() {
  ...
  p1.PlaceFirstSettlements(
      7, 3, 8, 3); // now p1 should have: 1-wheat, 2-wood, 2-wool, 1-ore
  p1.placeFirstRoads(7, 3, 8, 3, 8, 3, 9, 3);
  p1.endTurn();

  // p2: Settlements on tiles with resources: Brick (6) ,  ore (10) , wheat(12)
  // , wool (2 ) , wool (4) , wood(9)
  p2.PlaceFirstSettlements(
      3, 1, 6,
      1); // now p2 should have: 1-wheat, 1-brick, 1-ore, 2-wool, 1-wood
  ...
  // Player 2 (p2) builds another settlement and trades with Player 3 (p3), then
  // rolls the dice
