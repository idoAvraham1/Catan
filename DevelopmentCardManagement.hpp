...
class DevelopmentCardManagement {
  public:
     ...
     * @param giveMeThatResource The resource type to be collected from other
     * players.
     */
    ...
    static void
    useRoadCard(Player* player, size_t x1, size_t y1, size_t x2, size_t y2, size_t x3, size_t y3, size_t x4, size_t y4);

    /**
     * @brief Awards the Biggest Army card to the player if they have enough
     * knight cards.
  ...
  private:
     ...
     * @throws std::runtime_error if the player does not own the card or it is
     * not their turn.
     */
