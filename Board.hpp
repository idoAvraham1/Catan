...
private:
  ...
  // Data members to store tiles, vertices, edges, and vertex-to-tiles
  // association
  std::vector<Tile *> tiles;
  std::map<std::pair<size_t, size_t>, Vertex *>
      vertices; // Map to store unique vertices
  std::map<std::pair<Vertex *, Vertex *>, Edge *>
      edges; // Map to store unique edges
  std::map<Vertex *, std::vector<Tile *>>
      vertexToTiles; // Map to store vertex-to-tiles association
